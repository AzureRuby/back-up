...
--
myNormalBorderColor = "#0F161E"
myFocusedBorderColor = "#FFF01F"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_g), sendMessage $ setGaps [(L,1), (R,1), (U,1), (D,1)]) -- reset the GapSpec
...
myStartupHook = do
  ...
  spawnOnce "feh --bg-scale ~/Pictures/6330676.jpg"
  spawnOnce "picom --experimental-backends"
  spawn "exec ~/bin/system-mon"
------------------------------------------------------------------------
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,1), (R,1), (U,1), (D,1)] $ spacingRaw True (Border 1 1 1 1) True (Border 10 10 10 10) True $ smartBorders $ myLayout,
